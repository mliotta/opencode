...
nix run nixpkgs#opencode           # или github:mliotta/opencode для самой свежей ветки dev
```
...
OpenCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/mliotta/opencode/releases) или с [opencode.ai/download](https://opencode.ai/download).
