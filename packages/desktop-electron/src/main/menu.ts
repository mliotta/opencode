    ...
    { role: "windowMenu" },
    {
      ...
      submenu: [
        ...
        { type: "separator" },
        {
          ...
          click: () =>
            shell.openExternal("https://github.com/mliotta/opencode/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/mliotta/opencode/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
