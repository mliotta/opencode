...
nix run nixpkgs#opencode           # o github:mliotta/opencode para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/mliotta/opencode/releases) o desde [opencode.ai/download](https://opencode.ai/download).
